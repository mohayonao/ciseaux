...
describe("renderer", () => {
  ...
  describe("util", () => {
    describe("to_buffer(array: TypedArray): AudioBuffer", () => {
      it("works", () => {
        let f32 = new Float32Array(10);

        assert(renderer.util.to_buffer(f32) === f32.buffer);
      });
    });
    describe("alloc_data(tape): Float32Array[]", () => {
      it("works", () => {
        let tape = {
          tracks: [
            [
        ...
        let data = renderer.util.alloc_data(tape);
    ...
    describe("render(tape: object, destination: Float32Array[]): void", () => {
      it("works", (done) => {
        ...
        let destination = renderer.util.alloc_data(tape);

        setTimeout(function() {
          renderer.util.render(tape, destination);
    ...
    describe("subarray(array: Float32Array[], begin: number, end: number): Float32Array[]", () => {
      it("works", () => {
        ...
        let subarray = renderer.util.subarray(source, 2, 5);
  ...
  describe("pan(src: number[], l: number, r: number): number[]", () => {
    ...
    it("1", () => {
      let src = [ C ];
      let dst = renderer.util.pan[1](src, PAN_L, PAN_R);
    ...
    it("2", () => {
      let src = [ L, R ];
      let dst = renderer.util.pan[2](src, PAN_L, PAN_R);
    ...
    it("4", () => {
      let src = [ L, R, SL, SR ];
      let dst = renderer.util.pan[4](src, PAN_L, PAN_R);
    ...
    it("6", () => {
      ...
      let dst = renderer.util.pan[6](src, PAN_L, PAN_R);
  ...
  describe("mix1(src: number[]): number[]", () => {
    ...
    it("nop", () => {
      let src = [ L, C, R ];
      let dst = renderer.util.mix1.nop(src);

      assert(src === dst);
    });
    it("1->2", () => {
      let src = [ C ];
      let dst = renderer.util.mix1["1->2"](src);
    ...
    it("1->4", () => {
      let src = [ C ];
      let dst = renderer.util.mix1["1->4"](src);
    ...
    it("1->6", () => {
      let src = [ C ];
      let dst = renderer.util.mix1["1->6"](src);
    ...
    it("2->4", () => {
      ...
      let dst = renderer.util.mix1["2->4"](src);
    ...
    it("2->6", () => {
      let src = [ L, R ];
      let dst = renderer.util.mix1["2->6"](src);
    ...
    it("4->6", () => {
      let src = [ L, R, SL, SR ];
      let dst = renderer.util.mix1["4->6"](src);
    ...
    it("2->1", () => {
      let src = [ L, R ];
      let dst = renderer.util.mix1["2->1"](src);
    ...
    it("4->1", () => {
      ...
      let dst = renderer.util.mix1["4->1"](src);
    ...
    it("6->1", () => {
      let src = [ L, R, C, LFE, SL, SR ];
      let dst = renderer.util.mix1["6->1"](src);
    ...
    it("4->2", () => {
      ...
      let dst = renderer.util.mix1["4->2"](src);
    ...
    it("6->2", () => {
      let src = [ L, R, C, LFE, SL, SR ];
      let dst = renderer.util.mix1["6->2"](src);
    ...
    it("6->4", () => {
      let src = [ L, R, C, LFE, SL, SR ];
      let dst = renderer.util.mix1["6->4"](src);
